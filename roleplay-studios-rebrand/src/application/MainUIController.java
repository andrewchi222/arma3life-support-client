...
public class MainUIController implements EventHandler<ActionEvent> {
    ...
    @FXML
    void initialize() {
	Tooltip tooltip = new Tooltip("Onsettt!!!!");
	...
	if (event.getSource().equals(interviewProcedureBtn)) {
		...
		alert.setTitle("RPS Support Client");
	...
	builder.append("[b]Found out about Roleplay Studios : [/b]").append(foundAboutTxt.getText());
	builder.append(System.getProperty("line.separator"));
	...
	builder.append(System.getProperty("line.separator"));
	builder.append("Created with RPS Support Client V" + Main.APP_VERSION);
