...
public class MainUIController implements EventHandler<ActionEvent> {
	...
	if (event.getSource().equals(interviewProcedureBtn)) {
		...
		alert.setTitle("Life Studios Support Client");
	...
	builder.append("[b]Found out about Life Studios : [/b]").append(foundAboutTxt.getText());
	builder.append(System.getProperty("line.separator"));
	...
	builder.append(System.getProperty("line.separator"));
	builder.append("Created with Life Studios Support Client V" + Main.APP_VERSION);
